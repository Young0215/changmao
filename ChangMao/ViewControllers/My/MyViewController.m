...
@interface MyViewController ()<WKUIDelegate,WKNavigationDelegate,WKScriptMessageHandler>
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    NSInteger uid = [[AppTools getLoginUser].userId integerValue];
    // @"http://www.168zgcm.com/mobile/user.php?uid=3"
    NSString *urlStr = [NSString stringWithFormat:@"http://www.168zgcm.com/mobile/user.php?uid=%ld",(long)uid];
    NSLog(@"uid == %ld",(long)uid);
...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationResponse:(WKNavigationResponse *)navigationResponse decisionHandler:(void (^)(WKNavigationResponsePolicy))decisionHandler{
    ...
    //    NSLog(@"22%@",navigationResponse.response.URL.absoluteString);
...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler{
    ...
    }else if ([urlString containsString:@"act=service"]){
        NSLog(@"包含");
        self.checkLoading = YES;
        self.tabBarController.tabBar.hidden = YES;
        
    }else if ([urlString containsString:@"act=proxy"]){
        NSLog(@"包含");
        self.checkLoading = YES;
        self.tabBarController.tabBar.hidden = YES;
        
    }else if ([urlString containsString:@"act=address_list"]){
        NSLog(@"包含");
        self.checkLoading = YES;
        self.tabBarController.tabBar.hidden = YES;
        
    }else if ([urlString containsString:@"act=address"]){
        NSLog(@"包含");
        self.checkLoading = YES;
        self.tabBarController.tabBar.hidden = YES;
        
    }else if ([urlString containsString:@"act=message_list"]){
        NSLog(@"包含");
        self.checkLoading = YES;
        self.tabBarController.tabBar.hidden = YES;
        
    }else if ([urlString containsString:@"act=affiliate"]){
        NSLog(@"包含");
        self.checkLoading = YES;
        self.tabBarController.tabBar.hidden = YES;
        
    }else if ([urlString containsString:@"act=account_manage"]){
        NSLog(@"包含");
        self.checkLoading = YES;
        self.tabBarController.tabBar.hidden = YES;
        
    }else if ([urlString containsString:@"act=account_raply"]){
        NSLog(@"包含");
        self.checkLoading = YES;
        self.tabBarController.tabBar.hidden = YES;
        
    }else if ([urlString containsString:@"act=profile"]){
        NSLog(@"包含");
        self.checkLoading = YES;
        self.tabBarController.tabBar.hidden = YES;
        
    }else if ([urlString containsString:@"act=collection_list"]){
        NSLog(@"包含");
        self.checkLoading = YES;
        self.tabBarController.tabBar.hidden = YES;
        
    }else if ([urlString containsString:@"act=follow_shop"]){
        NSLog(@"包含");
        self.checkLoading = YES;
        self.tabBarController.tabBar.hidden = YES;
        
    }else if ([urlString containsString:@"act=my_comment"]){
        NSLog(@"包含");
        self.checkLoading = YES;
        self.tabBarController.tabBar.hidden = YES;
        
    }else if ([urlString containsString:@"act=set_address"]){
        NSLog(@"包含");
        self.checkLoading = YES;
        self.tabBarController.tabBar.hidden = YES;
        
    }else if ([urlString containsString:@"act=bonus"]){
        NSLog(@"包含");
        self.checkLoading = YES;
        self.tabBarController.tabBar.hidden = YES;
        
    }else if ([urlString containsString:@"act=account_deposit"]){
        NSLog(@"包含");
        self.checkLoading = YES;
        self.tabBarController.tabBar.hidden = YES;
        
    }else if ([urlString containsString:@"act=account_detail"]){
        NSLog(@"包含");
        self.checkLoading = YES;
        self.tabBarController.tabBar.hidden = YES;
        
    }else if ([urlString containsString:@"act=account_log"]){
        NSLog(@"包含");
        self.checkLoading = YES;
        self.tabBarController.tabBar.hidden = YES;
        
    }else if ([urlString containsString:@"index.php"] || [urlString containsString:@"./index.php"]){
//        NSLog(@"包含");
