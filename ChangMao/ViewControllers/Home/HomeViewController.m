...
@interface HomeViewController ()<WKUIDelegate,WKNavigationDelegate,WKScriptMessageHandler>
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    // 创建URL
    NSURL *url = [NSURL URLWithString:@"http://www.168zgcm.com/mobile/"];
    // 创建Request
...
//        
//    }
    else if ([urlString containsString:@"catalog.php"]){
        NSLog(@"包含");
        self.checkLoading = YES;
