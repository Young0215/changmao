...
@interface ShoppingCarViewController ()<WKUIDelegate,WKNavigationDelegate,WKScriptMessageHandler>
...
//    NSString *urlStr = [NSString stringWithFormat:@"http://www.168zgcm.com/mobile/flow.php?",(long)uid];
//    NSLog(@"uid == %ld",(long)uid);
    NSString *urlStr = @"http://www.168zgcm.com/mobile/flow.php?";
    // 创建URL
