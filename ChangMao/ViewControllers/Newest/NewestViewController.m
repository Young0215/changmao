...
@interface NewestViewController ()<WKUIDelegate,WKNavigationDelegate,WKScriptMessageHandler>
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    // 创建URL
    NSURL *url = [NSURL URLWithString:@"http://www.168zgcm.com/mobile/searchindex.php?"];
    // 创建Request
